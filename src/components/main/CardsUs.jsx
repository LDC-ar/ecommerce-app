    ...
    <div className='content-card-us'>
      ...
      <div className='info-us'>
        ...
        <div className='icons-us'>
          <a href={link1} target='blank' className='links-us'><img src={LinkdeIn} alt='icono linkedIn'/> </a>
          <a href={link2} target='blank' className='links-us'><img src={Github} alt='icono Github'/> </a>
        </div>
      </div>
    </div>
  )
